...
const ContactPage = () => {
    ...
    return (
        <div className="container" style={{ marginTop: '30px' }}>
            <h1 style={{ textAlign: 'center', color: '#2e7d32', marginBottom: '30px' }}>Liên Hệ Với Chủ Vườn</h1>
            
            <div className="detail-container" style={{ alignItems: 'flex-start' }}>
                {/* Cột Trái: Thông tin */}
                <div className="detail-left" style={{ background: '#e8f5e9', padding: '30px', borderRadius: '10px' }}>
                    ...
                    <p style={{ marginBottom: '15px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                        ...
                        <span>Số 1, Đường Cây Cảnh, Khu Vườn Xanh</span>
                    </p>
                    <p style={{ marginBottom: '15px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <p>Chào mừng các bạn đến tham quan vườn cây vào các ngày cuối tuần!</p>
                </div>
                ...
                <div className="detail-right">
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '15px', marginTop: '15px' }}>
                        <input 
                            type="text" name="full_name" placeholder="Họ và tên của bạn" 
                            value={formData.full_name} onChange={handleChange} required 
                            style={{ padding: '12px', borderRadius: '5px', border: '1px solid #ccc' }}
                        />
                        <input 
                            type="email" name="email" placeholder="Email để liên lạc lại" 
                            value={formData.email} onChange={handleChange} required 
                            style={{ padding: '12px', borderRadius: '5px', border: '1px solid #ccc' }}
                        />
                        <textarea 
                            name="message" rows="5" placeholder="Nội dung tin nhắn..." 
                            value={formData.message} onChange={handleChange} required 
                            style={{ padding: '12px', borderRadius: '5px', border: '1px solid #ccc', fontFamily: 'inherit' }}
                        ></textarea>
                        
                        <button type="submit" style={{ padding: '12px', background: '#2e7d32', color: 'white', border: 'none', borderRadius: '5px', fontWeight: 'bold', cursor: 'pointer' }}>
                            Gửi Tin Nhắn
                        </button>
                    </form>
                </div>
