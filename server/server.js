...
app.use(
  cors({
    origin: [
      ...
      "http://103.237.86.60",
      "https://103.237.86.60", // HTTPS qua IP VPS
      "http://103.237.86.60:5173",
      "http://103.237.86.60:3000",
    ],
    credentials: true,
  }),
);
...
app.use(
  ...
  require("./src/routes/trackingLocationRoutes"),
);
app.use("/api/tracking-search", require("./src/routes/trackingSearchRoutes"));
app.use("/api/tracking-plant", require("./src/routes/trackingPlantRoutes"));
app.use(
  "/api/tracking-homepage",
  require("./src/routes/trackingHomepageRoutes"),
); // <--- [MỚI] THÊM ROUTE NÀY
